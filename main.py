...
def load_sprite_sheet(dir1,dir2,width,height,direcion=False):
    ...
    for image in images:
        ...
        for i in range(sprite_sheet.get_width()//width):
            ...
            sprites.append(pygame.transform.scale2x(surface)) # 32x32 to 64x64
...
def get_block(size):
    ...
    rect = pygame.Rect(96,0,size,size) #96,0 is the coordinate from where the image starts in the terrain sprite sheet
...
def handle_vertical_collision(player,objects,dy):
    ...
    for obj in objects:
        if pygame.sprite.collide_mask(player,obj):
            if dy>0: #On the object
                player.rect.bottom = obj.rect.top
                player.landed()
            elif dy<0: #Bumping the head on the object
...
class Player(pygame.sprite.Sprite):
    ...
    def update_sprite(self):
        ...
        sprite_index = (self.animation_count // self.ANIMATAION_DELAY) % len(sprites)
